...
So, there's not a commercial off-the-shelf solution that would solve our
...
So that leaves us with categories to focus on: All Things Data;
...
Data Validation: To do data validation, we (and Google) would rely on
